...
% Uncomment for realtime plot of optimization
%% Plot C_p 
%subplot(3,1,3);
%plot(T1(:,1), C_p(:,1));
%% Figure of merit
...
% Third part of FOM for the toxicity, i.e. AUC
Int_t2= @(t) Concentration(t, t_gate, C_p);
F3  = integral(Int_t2, 0, t_gate, 'ArrayValued',true);


%FOM for exponential of cancer stem cells dynamics
